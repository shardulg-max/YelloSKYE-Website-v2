...
export default function AutonomousAgents() {
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      ...
      {
        // Triggers exactly when the invisible tracking div crosses the center of the screen
  ...
  return (
    <section className="bg-white relative font-sans border-gray-100">
      ...
      {/* 1. THE INVISIBLE SCROLL TRACK 
        These 4 divs create the physical scroll height of the section (400vh).
        They are invisible, but as you scroll past them, they trigger the UI changes.
      */}
      ...
      {/* 2. THE LOCKED VISUAL CONTAINER 
        This absolute div spans the entire 400vh track. The sticky child inside it 
        locks to the screen, staying perfectly still while you scroll down the track.
      */}
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none z-10">
        <div className="sticky top-0 h-screen w-full flex flex-col justify-center pointer-events-auto overflow-hidden bg-white">
          ...
          {/* AESTHETIC GRID BACKGROUND (Locked to screen so it doesn't scroll) */}
          ...
          <div className="max-w-[1400px] w-full mx-auto px-6 lg:px-10 relative z-10 -mt-10 lg:-mt-0">
            ...
            {/* STATIC HEADER: Never moves, always visible */}
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
              ...
              {/* LEFT SIDE: In-place fading text */}
              <div className="w-full lg:w-5/12 relative h-[180px] md:h-[220px]">
                {AGENTS.map((agent, index) => {
              ...
              {/* RIGHT SIDE: The Locked Terminal */}
              <div className="w-full lg:w-7/12 flex justify-center lg:justify-end">
                <div className="w-full max-w-[650px] h-[450px] lg:h-[550px] bg-[#0A0A0A] rounded-[32px] shadow-[0_40px_100px_rgba(0,0,0,0.25)] border border-white/10 overflow-hidden relative transition-all duration-700 hover:shadow-[0_50px_120px_rgba(255,242,0,0.1)] group">
