...
const Footer = () => {
  ...
  // ════════════════════════════════════════
  return (
    // 1. ADDED THE FRAGMENT WRAPPER HERE
    <>
      
      {/* 2. ADDED YOUR NEW COMPONENT HERE (Right above the footer) */}
      <GlobalBottomCTA />

      {/* 3. YOUR EXISTING FOOTER REMAINS UNCHANGED */}
